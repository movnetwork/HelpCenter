...
15.数字代币：指BytomMOV目前支持的数字代币种类，包括但不限于BTM、ETH等。
...
8.3.本公司和BytomMOV所能够提供的数字代币管理服务并未包括所有已存在的数字代币，请勿通过BytomMOV操作任何BytomMOV不支持的数字代币。
...
8.公告通知。BytomMOV会以网站公告、弹窗提示等方式向您发送通知，例如通知您交易进展情况，或者提示您进行相关操作，请您及时予以关注。
